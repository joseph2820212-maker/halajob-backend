...
const WORK_MODE_DEFINITIONS = {
  onsite: {
    ...
    keywords_ar: ["حضوري", "مكتبي", "في المكتب", "داخل الشركة"],
    icon: "business",
    sort_order: 10,
  },
  remote: {
    ...
    keywords_ar: ["عن بعد", "من المنزل", "عمل من المنزل", "اونلاين"],
    icon: "public",
    sort_order: 20,
  },
  hybrid: {
    ...
    keywords_ar: ["هجين", "مختلط", "حضوري وعن بعد", "دوام مختلط"],
    icon: "sync_alt",
    sort_order: 30,
  },
};
