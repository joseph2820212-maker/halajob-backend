...
const UserApplyingJobSchema = new Schema(
  {
    ...
    cv_snapshot: {
      id: { type: Schema.Types.ObjectId, ref: "employee_cvs", default: null },
      title: { type: String, default: "", trim: true },
      file_name: { type: String, default: "", trim: true },
      file_path: { type: String, default: "", trim: true },
      template_key: { type: String, default: "", trim: true },
      source: { type: String, default: "", trim: true },
      visibility: { type: String, default: "", trim: true },
