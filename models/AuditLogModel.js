...
const AuditLogSchema = new Schema(
  {
    ...
    entity_type: {
      type: String,
      enum: ["job", "application", "interview", "job_invitation", "company", "company_member", "question_library", "message_template", "support_ticket", "subscription", "verification", "notification", "translation", "user", "admin", "other"],
      default: "other",
      index: true,
    },
