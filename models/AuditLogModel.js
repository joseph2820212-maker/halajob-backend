...
const AuditLogSchema = new Schema(
  {
    ...
    entity_type: {
      type: String,
      enum: ["job", "application", "interview", "company", "company_member", "question_library", "message_template", "support_ticket", "subscription", "verification", "notification", "translation", "user", "admin", "other"],
      default: "other",
      index: true,
    },
