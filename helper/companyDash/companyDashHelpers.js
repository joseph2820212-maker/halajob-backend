...
export const normalizeInterview = (interview) => ({
  ...
  meeting_join_instructions: interview.meeting_join_instructions || "",
  calendar_provider: interview.calendar_provider || "none",
  ...
  candidate_response: interview.candidate_response || { status: "pending", note: "", responded_at: null },
  reminders: interview.reminders || { day_before_sent_at: null, hour_before_sent_at: null },
  feedback: interview.feedback || { submitted_by: null, submitted_at: null, strengths: "", concerns: "", next_step: "" },
