...
| P1 | Add admin APIs or admin UI coverage for newer records: career passports, AI requests/limits, analytics events, content translations, and UI surfaces for the newly exposed admin invoice readers. Student verification, university membership, and invoice read workflows now have app/API baselines. |
