...
- Current reviewed code/proof-guard commit before this report refresh: `2dba6ad`
...
| `npm --prefix web test` | Passed | Full Vitest suite passed: 16 files / 56 tests after the web destructive-action guards. |
