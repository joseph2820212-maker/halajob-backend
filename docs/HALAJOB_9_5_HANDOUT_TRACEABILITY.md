...
| Docs are refreshed after final source proof and APK proof is current | Current proof docs now distinguish the clean `ff5b8ba` full launch-gate replay, the focused `8705162` maintainability mobile launch gate, and the current `4898355` mobile launch gate/APK rebuild with the restored navy header. |
