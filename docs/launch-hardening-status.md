...
| P0 | Expand negative authorization cases with real tokens: remaining inactive context permutations and admin permission boundaries. Expired access tokens, inactive app users, company member missing-permission cases, company job/application, university verification, and campus student application/event object-scope coverage now have seeded baselines. |
