...
| Backend/API structure and maintainability | 6.5 | 7.5 | Compatibility aliases and trust workflow logic are isolated in route/controller/model layers with focused verifier scripts, and generic admin resource sanitization/auditing is centralized in the resource controller with matching generic route coverage. Larger structure cleanup remains. |
