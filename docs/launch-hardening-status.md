...
| P1 | Add protected-route upload/download tests for trust evidence files, generated-CV public-link expiry/ownership policy, remaining export edge cases, MIME rejection, file size rejection, and path traversal. Public generated-CV download headers, public static access to `uploads/files`, student verification documents, dashboard/app company file downloads, and saved employee CV downloads are covered. |
