...
- Dashboard admin endpoints now expose `/dash/v1/ai/features`,
  ...
  dashboard admins can inspect requests, review errors, and manage feature
  enablement/limits without direct database edits.
