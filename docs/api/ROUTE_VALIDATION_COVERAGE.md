...
| Read-only endpoints allowed without body validator | 286 |
| Write/update/delete endpoints | 2149 |
| Write/update/delete endpoints with validator | 2149 |
| Write/update/delete endpoints missing validator | 0 |
