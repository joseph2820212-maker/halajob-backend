...
| `npm run test:integration:profile-uploads` | Passed, including seeker and company profile image MIME/size rejection and no image-field mutation on rejected uploads |
