...
Source contracts tested through: `d4d3a95`
...
| Web production build and SEO prerender | `npm --prefix web run build` passed after `d4d3a95`; SEO prerendered 14 routes |
...
| Full web test suite | `npm --prefix web test` passed 16 files / 59 tests after `d4d3a95` |
...
| UI action wiring | `npm run test:ui-actions` passed 12 source files and 15 route/UI pairs after `d4d3a95` |
