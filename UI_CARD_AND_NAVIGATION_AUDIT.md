...
| Job seeker | Job detail | Job overview card | Existing `_OpportunityDetailScreen`. | Light cream card with title, company, trust, location, salary. | Native screen | N/A | Error card with retry | Pending | Pending |
...
| Job seeker | Job detail | Requirements card | Existing content cards. | Light cream section card with clear bullets. | Native screen | "No detailed requirements added yet." | N/A | Pending | Pending |
...
| Job seeker | Applications | Application list cards | Existing `_ApplicationListCard`. | Light cream cards with status chips and clear next step. | Native screen | "No applications yet. Apply to a job to see it here." | Error card with retry | Pending | Pending |
| Job seeker | Application detail | Application detail screen | Existing `_ApplicationDetailScreen`. | Keep native screen; standardize cards/header. | Native screen | N/A | Error card with retry | Pending | Pending |
| Job seeker | Application detail | Interview status card | Existing response panel/dialogs. | Light cream card. Confirmation dialog allowed for accept/decline. | Native screen plus confirmation dialog | "No interviews scheduled yet." | Error card with retry | Pending | Pending |
...
| Job seeker | Application detail | Messages/update card | Existing messages card. | Native card with send area. No snackbar-only failure. | Native screen | "No messages yet." | Error card with retry | Pending | Pending |
