...
router.post("/:id/unread", validate(platformSchemas.notificationMarkReadSchema), NotificationV1Controller.markUnread);
router.patch("/:id/unread", validate(platformSchemas.notificationMarkReadSchema), NotificationV1Controller.markUnread);
router.delete("/:id", validate(platformSchemas.notificationMarkReadSchema), NotificationV1Controller.remove);
router.post("/:id/delete", validate(platformSchemas.notificationMarkReadSchema), NotificationV1Controller.remove);
